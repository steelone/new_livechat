...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('blacklists', models.ManyToManyField(blank=True, to='chat.BlacklistChat')),
        ...
        migrations.AddField(
            model_name='blacklistchat',
            name='contact',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='blacklist', to='chat.Contact'),
        ),
    ]
